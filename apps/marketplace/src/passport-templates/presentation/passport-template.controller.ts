...
export class PassportTemplateController {
    ...
    async createTemplate(
        ...
        const passportTemplateDto = passportTemplateDto_1.PassportTemplateCreateSchema.parse(body);
    ...
    async getTemplates() {
        try {
            ...
            return passportTemplates.map((pt) => passportTemplateDto_1.passportTemplateToDto(pt));
    } catch (error) {
