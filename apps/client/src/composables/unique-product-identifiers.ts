...
export interface IUniqueProductIdentifiersComposable {
  upis: Ref<UniqueProductIdentifierListItemDto[]>;
  loading: Ref<boolean>;
  ...
  deleteUpi: (uuid: string) => Promise<void>;
}

export function useUniqueProductIdentifiers(): IUniqueProductIdentifiersComposable {
