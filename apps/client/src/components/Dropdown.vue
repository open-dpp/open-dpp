...
<template>
  <Menu as="div" class="relative inline-block text-left">
    <div class="h-full">
      <MenuButton
        class="flex h-full items-center rounded-full px-3 py-1 text-gray-600 hover:cursor-pointer hover:text-black focus:outline-hidden focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-100"
        @click.stop
      >
    ...
    >
      <MenuItems
        ...
        :class="[position === 'above' ? 'bottom-full' : 'top-full']"
      >
        ...
        <div class="py-1">
          <MenuItem v-for="(item, index) in items" :key="index" v-slot="{ active }">
            <button
              class="group flex w-full items-center px-4 py-2 text-sm hover:cursor-pointer"
