...
import { type MemberRoleDtoType, type PermissionDto, type UserRoleDtoType } from "@open-dpp/dto";
...
<template>
  ...
  <DiffViewer>
    <template #oldValue>
      <PermissionList :permissions="props.oldValue" />
    </template>
    <template #newValue> <PermissionList :permissions="props.newValue" /></template>
  </DiffViewer>
</template>
