...
// Built via the shared @open-dpp/testing factory with explicit overrides that
// reproduce every field the tests assert in the rendered rows (id, kind,
// primary, publicUrl). publishedUrl stays null (factory default) so no
// "Published" badge renders.
