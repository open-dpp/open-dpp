...
function onEditSectionClicked(section: SectionDto) {
...
function onAddDataFieldClicked(section: SectionDto) {
...
function onAddSubSectionClicked(section: SectionDto) {
...
function isFirst(id: string) {
  return currentSections.value.subSections.findIndex(s => s.id === id) === 0;
}
...
async function onPublish(visibility: VisibilityLevel) {
