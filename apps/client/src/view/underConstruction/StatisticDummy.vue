            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="flex items-baseline">
                  ...
                  <div
                    class="ml-2 flex items-baseline text-sm font-semibold" :class="[
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          ...
          >
            ...
            <span class="ml-4 text-sm text-gray-600">{{ material.percentage }}%</span>
          </div>
        </div>
      </div>
              ...
              >
                <div class="relative pb-8">
                  ...
                  <div class="relative flex space-x-3">
                    <div>
                      <span
                        class="h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white" :class="[
