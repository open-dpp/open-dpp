  ...
  <div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
      <div class="bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12 dark:bg-gray-800/50 dark:shadow-none dark:outline dark:-outline-offset-1 dark:outline-white/10">
        <div class="space-y-6">
          <div>
            <label for="newPassword" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Password</label>
            <div class="mt-2">
          ...
          <div>
            <label for="newPasswordCheck" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Password repeat</label>
            <div class="mt-2">
