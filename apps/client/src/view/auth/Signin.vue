...
import { Button, Card, Checkbox, Divider, InputText, Message, Password } from "primevue";
      ...
      <template #content>
        <div class="flex flex-col gap-5">
          ...
          <div class="space-y-6">
            ...
            <div>
              <Button :loading="loading" class="w-full" :label="t('auth.signin.button')" @click="signin" />
            </div>
          </div>

          <div>
            <Divider align="center" class="mt-10">
              <span class="text-sm text-gray-500">{{ t('auth.signin.textForProviders') }}</span>
            </Divider>
