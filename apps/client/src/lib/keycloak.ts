...
export async function initializeKeycloak(keycloak: Keycloak) {
...
export async function updateKeycloakToken(keycloak: Keycloak, minValidity: number) {
...
export function generateRegistrationLink(token: string) {
