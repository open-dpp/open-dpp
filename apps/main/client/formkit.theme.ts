 ...
 *
 * @checksum - dd95df911311f173182852f1bddfb1e833096a2174ab13be06d926e6bcfb1eca
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__removeSelection": {
    ...
    "z-10": true,
    "dark:text-neutral-100": true,
    "in-[.group\/tag]:absolute": true,
    "in-[.group\/tag]:top-1/2": true,
    "in-[.group\/tag]:right-[0.5em]": true,
    "in-[.group\/tag]:-translate-y-1/2": true,
    "in-[.group\/tag]:w-[0.5em]!": true,
    "in-[.group\/tag]:aspect-1/1": true,
    "in-[.group\/tag]:text-inherit!": true,
  },
  ...
  "family:dropdown__listbox": {
    ...
    "dark:group-data-overscroll:border-neutral-100": true,
  },
  ...
  datepicker__panelHeader: {
    ...
    "[@media(max-width:431px)_and_(hover:none)]:group-[&:not([data-inline])]:grid-cols-[2.5em_1fr_2.5em_2.5em]":
      true,
    "[@media(max-width:431px)_and_(hover:none)]:group-data-[panel=time]/panel:group-[&:not([data-inline])]:grid-cols-[2.5em_1fr_2.5em]":
      true,
    "[@media(max-width:431px)_and_(hover:none)]:group-data-[panel=month]/panel:group-[&:not([data-inline])]:grid-cols-[2.5em_1fr_2.5em]":
      true,
  },
  ...
  repeater__controls: {
    ...
    "[&>li_button]:group-data-disabled/repeater:opacity-50": true,
    "[&>li_button]:group-data-disabled/repeater:text-neutral-500!": true,
    "[&>li_button]:group-data-disabled/repeater:pointer-events-none": true,
  ...
  togglebuttons__input: {
    ...
    "aria-pressed:bg-neutral-900": true,
    "aria-pressed:text-white": true,
    "dark:aria-pressed:bg-neutral-100": true,
    "dark:aria-pressed:text-black": true,
    "in-[.group\/option]:rounded-none!": true,
    "group-first/option:group-data-[vertical=false]/options:rounded-none!":
      true,
    "group-first/option:group-data-[vertical=true]/options:rounded-none!": true,
    "group-first/option:group-data-[vertical=false]/options:rounded-tr-none!":
      true,
    "group-first/option:group-data-[vertical=false]/options:rounded-br-none!":
      true,
    "group-first/option:group-data-[vertical=true]/options:rounded-bl-none!":
      true,
    "group-first/option:group-data-[vertical=true]/options:rounded-br-none!":
      true,
    "group-last/option:group-data-[vertical=false]/options:rounded-none!": true,
    "group-last/option:group-data-[vertical=true]/options:rounded-none!": true,
    "group-last/option:group-data-[vertical=false]/options:rounded-tl-none!":
      true,
    "group-last/option:group-data-[vertical=false]/options:rounded-bl-none!":
      true,
    "group-last/option:group-data-[vertical=true]/options:rounded-tl-none!":
      true,
    "group-last/option:group-data-[vertical=true]/options:rounded-tr-none!":
      true,
    ...
    "aria-pressed:in-[.group\/option]:group-data-[vertical=false]/options:border-x-neutral-100":
      true,
    "aria-pressed:group-first/option:group-data-[vertical=false]/options:border-l-neutral-900":
      true,
    "aria-pressed:group-last/option:group-data-[vertical=false]/options:border-r-neutral-900":
      true,
    "dark:aria-pressed:in-[.group\/option]:group-data-[vertical=false]/options:border-x-neutral-900":
      true,
    "dark:aria-pressed:group-first/option:group-data-[vertical=false]/options:border-l-neutral-100":
      true,
    "dark:aria-pressed:group-last/option:group-data-[vertical=false]/options:border-r-neutral-100":
      true,
    ...
    "aria-pressed:in-[.group\/option]:group-data-[vertical=true]/options:border-y-neutral-100":
      true,
    "aria-pressed:group-first/option:group-data-[vertical=true]/options:border-t-neutral-900":
      true,
    "aria-pressed:group-last/option:group-data-[vertical=true]/options:border-b-neutral-900":
      true,
    "dark:aria-pressed:in-[.group\/option]:group-data-[vertical=true]/options:border-y-neutral-900":
      true,
    "dark:aria-pressed:group-first/option:group-data-[vertical=true]/options:border-t-neutral-100":
      true,
    "dark:aria-pressed:group-last/option:group-data-[vertical=true]/options:border-b-neutral-100":
      true,
  },
  transferlist__outer: {
    group: true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[hide-labels=true]/wrapper:group-data-[tab-style=progress]/wrapper:mb-3.5":
      true,
  },
  "multi-step__tab": {
    "group/tab": true,
    ...
    "data-[active=true]:group-data-[tab-style=tab]/wrapper:border-b-transparent":
      true,
    ...
    "dark:data-[active=true]:group-data-[tab-style=tab]/wrapper:bg-transparent":
      true,
    "dark:data-[active=true]:group-data-[tab-style=tab]/wrapper:border-b-transparent":
      true,
    "dark:group-data-[tab-style=tab]/wrapper:border-neutral-100": true,
    ...
    "data-[visited=true]:data-[valid=true]:group-data-[tab-style=progress]/wrapper:after:bg-neutral-900":
      true,
    ...
    "dark:data-[visited=true]:data-[valid=true]:group-data-[tab-style=progress]/wrapper:after:bg-neutral-300":
      true,
  },
