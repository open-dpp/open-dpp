...
const classes: Record<string, Record<string, boolean>> = {
  ...
  togglebuttons__input: {
    ...
    'group-first/option:group-data-[vertical=false]/options:rounded-none!': true,
    ...
    'aria-pressed:in-[.group\/option]:group-data-[vertical=false]/options:border-x-neutral-100': true,
    'aria-pressed:group-first/option:group-data-[vertical=false]/options:border-l-neutral-900': true,
    'aria-pressed:group-last/option:group-data-[vertical=false]/options:border-r-neutral-900': true,
    'dark:aria-pressed:in-[.group\/option]:group-data-[vertical=false]/options:border-x-neutral-900': true,
    'dark:aria-pressed:group-first/option:group-data-[vertical=false]/options:border-l-neutral-100': true,
    'dark:aria-pressed:group-last/option:group-data-[vertical=false]/options:border-r-neutral-100': true,
    ...
    'aria-pressed:in-[.group\/option]:group-data-[vertical=true]/options:border-y-neutral-100': true,
    'aria-pressed:group-first/option:group-data-[vertical=true]/options:border-t-neutral-900': true,
    'aria-pressed:group-last/option:group-data-[vertical=true]/options:border-b-neutral-900': true,
    'dark:aria-pressed:in-[.group\/option]:group-data-[vertical=true]/options:border-y-neutral-900': true,
    'dark:aria-pressed:group-first/option:group-data-[vertical=true]/options:border-t-neutral-100': true,
    'dark:aria-pressed:group-last/option:group-data-[vertical=true]/options:border-b-neutral-100': true,
  },
  transferlist__outer: {
    group: true,
    grow: true,
  ...
  'multi-step__tab': {
    ...
    'data-[active=true]:group-data-[tab-style=tab]/wrapper:border-b-transparent': true,
    ...
    'data-[visited=true]:data-[valid=true]:group-data-[tab-style=progress]/wrapper:after:bg-neutral-900': true,
    ...
    'dark:data-[visited=true]:data-[valid=true]:group-data-[tab-style=progress]/wrapper:after:bg-neutral-300': true,
  },
