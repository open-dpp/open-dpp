<template>
  <div
    :class="[
      props.className,
      'group grow min-w-0 text-base mb-4 data-disabled:select-none data-disabled:opacity-50 data-disabled:pointer-events-none formkit-outer',
    ]"
...
const updateFileFromModal = async (items: Array<MediaInfo>) => {
  if (items.length === 0) {
