 ...
 * row is a system OPEN_DPP_UUID). A duplicate resulting key surfaces as 409.
 *
 * DELETE /unique-product-identifiers/:id — delete a single GS1 UPI while the
 * referenced passport is a draft (409 if published or if the row is a system
 * OPEN_DPP_UUID). Returns 204 on success.
 */
