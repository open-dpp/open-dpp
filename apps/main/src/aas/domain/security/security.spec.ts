...
describe("security", () => {
  it("create security schema and checks permissions", () => {
    ...
    expect(ability.can({ action: Permissions.Edit, object: IdShortPath.create({ path: "section1.field1" }) })).toBeTruthy();
    ...
    expect(ability.can({ action: Permissions.Read, object: IdShortPath.create({ path: "section1.subsection1.field1" }) })).toBeTruthy();
