...
export class ValueModifierVisitor implements IVisitor<ValueModifierVisitorContextType, void> {
  ...
  visitSubmodelElementCollection(element: SubmodelElementCollection, context?: ValueModifierVisitorContextType): void {
  ...
  visitSubmodelElementList(element: SubmodelElementList, context?: ValueModifierVisitorContextType): void {
