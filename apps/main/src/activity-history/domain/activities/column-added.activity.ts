...
const ColumnAddedActivityVersion = {
  v1_0_0: "1.0.0",
} as const;

export class ColumnAddedActivity implements IActivity {
  public static readonly type = ActivityTypes.ColumnAdded;
  private constructor(
  ...
  static create(
    ...
    return new ColumnAddedActivity(
