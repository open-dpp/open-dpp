...
const SubmodelValueModifiedActivityVersion = {
  v1_0_0: "1.0.0",
} as const;

export class SubmodelValueModifiedActivity implements IActivity {
  public static readonly type = ActivityTypes.SubmodelValueModified;
  private constructor(
  ...
  static create(
    ...
    return new SubmodelValueModifiedActivity(
      createActivityHeader(
        SubmodelValueModifiedActivity.type,
        data,
        SubmodelValueModifiedActivityVersion.v1_0_0,
      ),
