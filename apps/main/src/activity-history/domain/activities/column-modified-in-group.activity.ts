...
const ColumnModifiedInGroupActivityVersion = {
  v1_0_0: "1.0.0",
} as const;

export class ColumnModifiedInGroupActivity implements IActivity {
  public static readonly type = ActivityTypes.ColumnModifiedInGroup;
  private constructor(
  ...
  static create(
    ...
    return new ColumnModifiedInGroupActivity(
      createActivityHeader(
        ColumnModifiedInGroupActivity.type,
        data,
        ColumnModifiedInGroupActivityVersion.v1_0_0,
      ),
