...
const ColumnAddedToGroupActivityVersion = {
  v1_0_0: "1.0.0",
} as const;

export class ColumnAddedToGroupActivity implements IActivity {
  public static readonly type = ActivityTypes.ColumnAddedToGroup;
  private constructor(
  ...
  static create(
    ...
    return new ColumnAddedToGroupActivity(
      createActivityHeader(
        ColumnAddedToGroupActivity.type,
        data,
        ColumnAddedToGroupActivityVersion.v1_0_0,
      ),
