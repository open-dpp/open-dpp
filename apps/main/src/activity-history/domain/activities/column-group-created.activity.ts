...
const ColumnGroupCreatedActivityVersion = {
  v1_0_0: "1.0.0",
} as const;

export class ColumnGroupCreatedActivity implements IActivity {
  public static readonly type = ActivityTypes.ColumnGroupCreated;
  private constructor(
  ...
  static create(
    ...
    return new ColumnGroupCreatedActivity(
      createActivityHeader(
        ColumnGroupCreatedActivity.type,
        data,
        ColumnGroupCreatedActivityVersion.v1_0_0,
      ),
