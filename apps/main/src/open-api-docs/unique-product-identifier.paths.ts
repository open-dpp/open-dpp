...
export const uniqueProductIdentifierPaths = {
  "/unique-product-identifiers": {
    get: {
      ...
      summary: "Returns a page of unique product identifiers for the organization (system + GS1)",
  ...
  "/unique-product-identifiers/internal": {
    post: {
      tags: ["unique-product-identifiers"],
      summary:
      ...
      requestBody: {
        content: {
          [ContentType.JSON]: {
            schema: CreateInternalUniqueProductIdentifierRequestSchema,
          },
        },
      },
      responses: {
  ...
  "/unique-product-identifiers/{id}": {
    ...
    patch: {
      tags: ["unique-product-identifiers"],
      summary: "Updates a GS1 unique product identifier (gtin/batch/serial) — draft passport only",
      parameters: [upiIdParamSchema, orgaIdHeader],
      requestBody: {
        content: {
          [ContentType.JSON]: {
    ...
    delete: {
      tags: ["unique-product-identifiers"],
      summary:
        "Deletes a unique product identifier — draft passport only; GTIN/EAN system rows are rejected",
      parameters: [upiIdParamSchema, orgaIdHeader],
      responses: {
        [HTTPCode.NO_CONTENT]: {},
      },
  ...
  "/passports/{id}/unique-product-identifiers": {
    get: {
      tags: ["unique-product-identifiers"],
      summary: "Returns a page of unique product identifiers for a passport (system + GS1)",
      parameters: [
