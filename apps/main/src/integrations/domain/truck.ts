  ...
  assetAdministrationShells: [
    {
      ...
      assetInformation: {
        assetKind: "Instance",
        assetType: "product",
        globalAssetId: "Truck_-10204004-0010",
      },
      submodels: [
        {
          keys: [
            {
              type: "Submodel",
              value: "Truck_-10204004-0010_BOM",
            },
          ],
          referredSemanticId: {
            keys: [
        ...
        },
        {
          keys: [
            {
              type: "Submodel",
              value: "Truck_-10204004-0010_Nameplate",
            },
          ],
          referredSemanticId: {
            keys: [
        ...
        },
        {
          keys: [
            {
              type: "Submodel",
              value: "Truck_-10204004-0010_CarbonFootprint",
            },
          ],
          referredSemanticId: {
            keys: [
      ...
      id: "Truck_-10204004-0010",
      displayName: [
        {
          language: "DE",
          text: "de.proalpha.product.truck",
        },
      ],
      idShort: "Truck",
    },
  ...
  submodels: [
    {
      ...
      id: "Truck_-10204004-0010_Nameplate",
      description: [
        {
          language: "DE",
    ...
    },
    {
      ...
      id: "Truck_-10204004-0010_CarbonFootprint",
      description: [
        {
          language: "DE",
          ...
          statements: [
            ...
            },
            {
              ...
              statements: [
                {
                  modelType: "Property",
                  value: "Semitrailer_Truck_-10204004-0010-02",
                  valueType: "xs:string",
                  idShort: "Id",
                },
                {
            ...
            },
            {
              ...
              second: {
                keys: [
                  ...
                  {
                    Entity: "Semitrailer_-10204004-0010-01",
                  },
                ],
                type: "ModelReference",
              },
            },
            {
              ...
              second: {
                keys: [
                  ...
                  {
                    Entity: "Semitrailer_Truck_-10204004-0010-02",
                  },
                ],
                type: "ModelReference",
              },
