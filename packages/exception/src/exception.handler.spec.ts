...
import { NotFoundInDatabaseExceptionFilter, ValueErrorFilter } from "./exception.handler";
...
describe("exceptionFilter", () => {
  ...
  beforeEach(async () => {
    ...
    notFoundInDatabaseExceptionFilter = module.get<NotFoundInDatabaseExceptionFilter>(
    ...
    jest.spyOn(Date.prototype, "toISOString").mockReturnValue("2025-03-26T12:00:00.000Z");
  });
  ...
  it("should include the correct error message in the response", () => {
    ...
    // Call the filter
    notFoundInDatabaseExceptionFilter.catch(exception as any, mockArgumentsHost);
