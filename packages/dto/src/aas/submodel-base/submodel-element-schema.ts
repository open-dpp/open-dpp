...
export const SubmodelElementSharedSchema = z.looseObject({
  ...SubmodelBaseJsonSchema.shape,
  modelType: z.string(),
});
export type SubmodelElementSharedResponseDto = z.infer<typeof SubmodelElementSharedSchema>;

export const SubmodelElementSchema: z.ZodTypeAny<SubmodelElementSharedResponseDto> = z
  .lazy(() => SubmodelElementSchemaJsonImpl())
...
export const SubmodelElementPaginationResponseDtoSchema = z
  .object({
...
export type SubmodelElementPaginationResponseDto = z.infer<
  typeof SubmodelElementPaginationResponseDtoSchema
>;
