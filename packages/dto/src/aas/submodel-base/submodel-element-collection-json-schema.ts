...
export const SubmodelElementCollectionJsonSchema = z
  .lazy(() => SubmodelElementCollectionJsonSchemaImpl())
...
export type SubmodelElementCollectionRequestDto = z.input<
  typeof SubmodelElementCollectionJsonSchema
>;
export type SubmodelElementCollectionResponseDto = z.infer<
  typeof SubmodelElementCollectionJsonSchema
>;

export const SubmodelElementCollectionModificationSchema = z
  .object({
...
export type SubmodelElementCollectionModificationDto = z.infer<
  typeof SubmodelElementCollectionModificationSchema
>;
