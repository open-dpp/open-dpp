...
export const SubmodelElementListJsonSchema = z
  .lazy(() => SubmodelElementListJsonSchemaImpl())
...
export const SubmodelElementListModificationSchema = z
  .object({
...
export type SubmodelElementListModificationDto = z.input<
  typeof SubmodelElementListModificationSchema
>;
