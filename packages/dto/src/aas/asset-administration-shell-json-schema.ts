...
import {
  AssetInformationJsonSchema,
  AssetInformationModificationSchema,
} from "./asset-information-json-schema";
...
export type AssetAdministrationShellCreateDto = z.input<
  typeof AssetAdministrationShellCreateDtoSchema
>;
export type AssetAdministrationShellResponseDto = z.infer<
  typeof AssetAdministrationShellJsonSchema
>;

export type AssetAdministrationShellRequestDto = z.input<typeof AssetAdministrationShellJsonSchema>;

export const AssetAdministrationShellModificationSchema =
  NameAndDescriptionModificationSchema.extend({
