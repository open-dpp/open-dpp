...
/**
 * The complete GS1 Application Identifier table (541 entries), keyed by AI string.
 */
export const GS1_AI_TABLE: Readonly<Record<string, Gs1AiTableEntry>> = {
  ...
  "02": {
    ai: "02",
    title: "Global Trade Item Number (GTIN) of contained trade items",
    format: "N14",
    type: "D",
    fixedLength: true,
    regex: "(\\d{14})",
  ...
  "03": {
    ai: "03",
    title: "Identification of a Made-to-Order (MtO) trade item (GTIN)",
    format: "N14",
    type: "N",
    fixedLength: true,
    regex: "(\\d{14})",
  ...
  "235": {
    ai: "235",
    title: "Third Party Controlled, Serialised Extension of Global Trade Item Number (GTIN) (TPX)",
    format: "X..28",
    type: "Q",
    fixedLength: false,
  ...
  "254": {
    ai: "254",
    title: "Global Location Number (GLN) extension component",
    format: "X..20",
    type: "Q",
    fixedLength: false,
    regex: "([!%-?A-Z_a-z\\x22]{1,20})",
  ...
  "37": {
    ai: "37",
    title: "Count of trade items or trade item pieces contained in a logistic unit",
    format: "N..8",
    type: "D",
    fixedLength: false,
    regex: "(\\d{1,8})",
  ...
  "3950": {
    ai: "3950",
    title: "Amount Payable per unit of measure single monetary area (variable measure trade item)",
    format: "N6",
    type: "D",
    fixedLength: false,
    regex: "(\\d{6})",
  ...
  "400": {
    ai: "400",
    title: "Customers purchase order number",
    format: "X..30",
    type: "D",
    fixedLength: false,
    regex: "([!%-?A-Z_a-z\\x22]{1,30})",
  ...
  "410": {
    ai: "410",
    title: "Ship to / Deliver to Global Location Number (GLN)",
    format: "N13",
    type: "D",
    fixedLength: true,
    regex: "(\\d{13})",
  ...
  "411": {
    ai: "411",
    title: "Bill to / Invoice to Global Location Number (GLN)",
    format: "N13",
    type: "D",
    fixedLength: true,
    regex: "(\\d{13})",
  ...
  "412": {
    ai: "412",
    title: "Purchased from Global Location Number (GLN)",
    format: "N13",
    type: "D",
    fixedLength: true,
    regex: "(\\d{13})",
  ...
  "413": {
    ai: "413",
    title: "Ship for / Deliver for - Forward to Global Location Number (GLN)",
    format: "N13",
    type: "D",
    fixedLength: true,
    regex: "(\\d{13})",
  ...
  "414": {
    ai: "414",
    title: "Identification of a physical location - Global Location Number (GLN)",
    format: "N13",
    type: "I",
    fixedLength: true,
    regex: "(\\d{13})",
  ...
  "415": {
    ai: "415",
    title: "Global Location Number (GLN) of the invoicing party",
    format: "N13",
    type: "I",
    fixedLength: true,
    regex: "(\\d{13})",
  ...
  "416": {
    ai: "416",
    title: "Global Location Number (GLN) of the production or service location",
    format: "N13",
    type: "D",
    fixedLength: true,
    regex: "(\\d{13})",
  ...
  "417": {
    ai: "417",
    title: "Party Global Location Number (GLN)",
    format: "N13",
    type: "I",
    fixedLength: true,
    regex: "(\\d{13})",
  ...
  "4301": {
    ai: "4301",
    title: "Ship-to / Deliver-to contact",
    format: "X..35",
    type: "D",
    fixedLength: false,
    regex: "((?:[!%-?A-Z_a-z\\x22]|%[0-9A-Fa-f][0-9A-Fa-f]%[0-9A-Fa-f][0-9A-Fa-f]){1,35})",
  ...
  "4324": {
    ai: "4324",
    title: "Not before delivery date time (YYMMDDhhmm)",
    format: "N10",
    type: "D",
    fixedLength: false,
    regex: "(\\d{10})",
  ...
  "4325": {
    ai: "4325",
    title: "Not after delivery date time (YYMMDDhhmm)",
    format: "N10",
    type: "D",
    fixedLength: false,
    regex: "(\\d{10})",
  ...
  "4330": {
    ai: "4330",
    title: "Maximum temperature in Fahrenheit (expressed in hundredths of degrees)",
    format: "N6+[-]",
    type: "D",
    fixedLength: false,
    regex: "(\\d{6}[-]?)",
  ...
  "4331": {
    ai: "4331",
    title: "Maximum temperature in Celsius (expressed in hundredths of degrees)",
    format: "N6+[-]",
    type: "D",
    fixedLength: false,
    regex: "(\\d{6}[-]?)",
  ...
  "4332": {
    ai: "4332",
    title: "Minimum temperature in Fahrenheit (expressed in hundredths of degrees)",
    format: "N6+[-]",
    type: "D",
    fixedLength: false,
    regex: "(\\d{6}[-]?)",
  ...
  "4333": {
    ai: "4333",
    title: "Minimum temperature in Celsius (expressed in hundredths of degrees)",
    format: "N6+[-]",
    type: "D",
    fixedLength: false,
    regex: "(\\d{6}[-]?)",
  ...
  "7003": {
    ai: "7003",
    title: "Expiration date and time (YYMMDDhhmm)",
    format: "N10",
    type: "D",
    fixedLength: false,
    regex: "(\\d{10})",
  ...
  "7006": {
    ai: "7006",
    title: "First freeze date (YYMMDD)",
    format: "N6",
    type: "D",
    fixedLength: false,
    regex: "(\\d{6})",
  ...
  "7007": {
    ai: "7007",
    title: "Harvest date (YYMMDD[YYMMDD])",
    format: "N6[+N6]",
    type: "D",
    fixedLength: false,
    regex: "(\\d{6})(\\d{6})?",
  ...
  "7011": {
    ai: "7011",
    title: "Test by date (YYMMDD[hhmm])",
    format: "N6[+N4]",
    type: "D",
    fixedLength: false,
    regex: "(\\d{6})(\\d{4})?",
  ...
  "7030": {
    ai: "7030",
    title: "Number of processor with three-digit ISO country code",
    format: "N3+X..27",
    type: "D",
    fixedLength: false,
  ...
  "7041": {
    ai: "7041",
    title: "UN/CEFACT freight unit type",
    format: "X..4",
    type: "N",
    fixedLength: false,
  ...
  "717": {
    ai: "717",
    title: "National Healthcare Reimbursement Number (NHRN) - Costa Rica Sanitary Register Number",
    format: "X..20",
    type: "D",
    fixedLength: false,
    regex: "([!%-?A-Z_a-z\\x22]{1,20})",
  ...
  "7242": {
    ai: "7242",
    title: "Version Control Number (VCN)",
    format: "X..25",
    type: "D",
    fixedLength: false,
  ...
  "7251": {
    ai: "7251",
    title: "Date and time of birth (YYYYMMDDhhmm)",
    format: "N12",
    type: "D",
    fixedLength: false,
  ...
  "8006": {
    ai: "8006",
    title: "Identification of an individual trade item piece (ITIP)",
    format: "N14+N2+N2",
    type: "I",
    fixedLength: false,
    regex: "(\\d{14})(\\d{4})",
  ...
  "8008": {
    ai: "8008",
    title: "Date and time of production (YYMMDDhh[mm[ss]])",
    format: "N8[+N..4]",
    type: "D",
    fixedLength: false,
    regex:
      "(\\d{2}(?:0\\d|1[0-2])(?:[0-2]\\d|3[01])(?:[01]\\d|2[0-3]))((?:[0-5]\\d)(?:[0-5]\\d)?)?",
  },
  "8009": {
    ai: "8009",
  ...
  "8014": {
    ai: "8014",
    title: "Highly Individualised Device Registration Identifier (HIDRI)",
    format: "X..25",
    type: "N",
    fixedLength: false,
    regex: "([!%-?A-Z_a-z\\x22]{1,25})",
  ...
  "8026": {
    ai: "8026",
    title: "Identification of pieces of a trade item (ITIP) contained in a logistic unit",
    format: "N14+N2+N2",
    type: "D",
    fixedLength: false,
    regex: "(\\d{14})(\\d{4})",
  ...
  "8030": {
    ai: "8030",
    title: "Digital Signature (DigSig)",
    format: "Z..90",
    type: "D",
    fixedLength: false,
  ...
  "8040": {
    ai: "8040",
    title: "Internatinal Mobile Equipment Identity (IMEI)",
    format: "N15",
    type: "D",
    fixedLength: false,
    regex: "(\\d{15})",
  ...
  "8041": {
    ai: "8041",
    title: "Internatinal Mobile Equipment Identity 2 (IMEI2)",
    format: "N15",
    type: "D",
    fixedLength: false,
    regex: "(\\d{15})",
  ...
  "8112": {
    ai: "8112",
    title: "Positive offer file coupon code identification for use in North America",
    format: "X..70",
    type: "D",
    fixedLength: false,
    regex: "([!%-?A-Z_a-z\\x22]{1,70})",
