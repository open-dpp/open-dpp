...
export class AgentServerApiClient implements IApiClient {
  ...
  private createNewAxiosInstance() {
    this.axiosInstance = createAxiosClient(this.options, "https://agent-server.cloud.open-dpp.de");
    this.aiConfigurations = new AiConfigurationNamespace(this.axiosInstance);
  }
}
