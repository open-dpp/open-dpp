...
export class AasIntegrationNamespace {
  ...
  public async getAllConnections() {
    return this.axiosInstance.get<AasConnectionGetAllDto[]>(this.aasConnectionsEndpoint);
  }

  public async createConnection(data: CreateAasConnectionDto) {
    return this.axiosInstance.post<AasConnectionDto>(this.aasConnectionsEndpoint, data);
  }

  public async modifyConnection(connectionId: string, data: UpdateAasConnectionDto) {
