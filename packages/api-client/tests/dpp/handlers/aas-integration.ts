...
import { AssetAdministrationShellType } from "../../../src";
...
export const aasIntegrationHandlers = [
  http.get(`${baseURL}/integration/aas/connections/${connection.id}`, () => {
    return HttpResponse.json({ ...connection });
  }),
  http.get(`${baseURL}/integration/aas/connections`, () => {
    return HttpResponse.json(connectionList);
  }),
  http.post(`${baseURL}/integration/aas/connections`, () => {
    return HttpResponse.json({ ...connection });
  }),
  http.patch(`${baseURL}/integration/aas/connections/${connection.id}`, () => {
    return HttpResponse.json({ ...connection });
  }),
  http.get(`${baseURL}/integration/aas/Truck/properties`, () => {
