...
export const aasPlainFactory = Factory.define<
  z.input<typeof AssetAdministrationShellJsonSchema>,
  AasTransientParams
>(({ transientParams }) => ({
      ...
      accessPermissionRules: [
        {
          targetSubjectAttributes: {
            subjectAttribute: [
              propertyInputPlainFactory.build({ idShort: "userRole", value: "user" }),
              propertyInputPlainFactory.build({ idShort: "memberRole", value: "member" }),
            ],
          },
