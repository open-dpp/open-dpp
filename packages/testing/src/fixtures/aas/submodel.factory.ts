...
export const submodelDesignOfProductPlainFactory = Factory.define<
  Partial<Input>,
  SubmodelTransientParams
          ...
          },
          {
            ...
            value: [
              ...
              },
              {
                ...
                value:
                  "",
                idShort: "BlobProp",
              },
              {
                modelType: "File",
...
export const submodelDesignOfProductValuePlainFactory = Factory.define<any>(() => ({
  Design_V01: {
...
export const submodelCarbonFootprintPlainFactory = Factory.define<
  Partial<Input>,
  SubmodelTransientParams
>(({ transientParams }) => ({
  modelType: "Submodel",
...
export const submodelBillOfMaterialPlainFactory = Factory.define<
  Partial<Input>,
  SubmodelTransientParams
>(({ transientParams }) => ({
  modelType: "Submodel",
